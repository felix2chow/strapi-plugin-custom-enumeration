...
export default {
  register(app) {
    app.customFields.register({
      ...
      pluginId: 'custom-enumeration',
      type: 'string',
      icon: MultiSelectIcon,
      intlLabel: {
        id: getTrad('custom-enumeration.label'),
        defaultMessage: 'Multi Select',
      },
      intlDescription: {
        id: getTrad('custom-enumeration.description'),
            ...
            items: [
              {
                ...
                type: 'textarea-enum',
                intlLabel: {
                  id: getTrad('custom-enumeration.enum.label'),
                  defaultMessage: 'Options (one per line)',
                },
                description: {
                  id: getTrad('custom-enumeration.enum.description'),
                  defaultMessage:
                ...
                placeholder: {
                  id: getTrad('custom-enumeration.enum.placeholder'),
                  defaultMessage: 'Ex:\nOption 1\nOption 2\nOption 3:option-3',
                },
              },
            ],
